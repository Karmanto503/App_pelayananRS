...
public class DataKunjungan extends javax.swing.JDialog {
    ...
    public DataKunjungan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataKunjungan dialog = new DataKunjungan(new javax.swing.JFrame(), true);
    ...
    private void getData(DefaultTableModel model) {
        ...
        try {
            String sql = "SELECT id_kunjungan, tgl_kunjungan, keluhan, diagnosis FROM tbl_kunjungan";
            try(PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    ...
                    Object[] rowData = {idKunjungan,tglKunjungan,keluhan,diagnosis};
    ...
    private void searchData() {
        ...
        try {
            String sql = "SELECT * FROM tbl_kunjungan WHERE keluhan LIKE ?";
            try(PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    String idPasien         = rs.getString("id_kunjungan");
                    String namaPasien       = rs.getString("tgl_kunjungan");
                    String alamat           = rs.getString("keluhan");
                    String telepon          = rs.getString("diagnosis");
                    
                    Object[] rowData = {idPasien,namaPasien,alamat,telepon};
                    model.addRow(rowData);
                }
            }
        } catch (Exception e) {
    ...
    private void pilihData(){
        ...
        idKunjungan = tblData.getValueAt(row, 0).toString();
        tglKunjungan = tblData.getValueAt(row, 1).toString();
        keluhan = tblData.getValueAt(row, 2).toString();
        diagnosis = tblData.getValueAt(row, 3).toString();
