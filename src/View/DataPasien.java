...
public class DataPasien extends javax.swing.JDialog {
    ...
    public DataPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataPasien dialog = new DataPasien(new javax.swing.JFrame(), true);
    ...
    private void getData(DefaultTableModel model) {
        ...
        try {
            String sql = "SELECT id_pasien, nm_pasien, alamat, no_telpon FROM tbl_pasien";
    ...
    private void searchData() {
        ...
        try {
            String sql = "SELECT * FROM tbl_pasien WHERE nm_pasien LIKE ?";
            try(PreparedStatement st = conn.prepareStatement(sql)) {
    ...
    private void pilihData(){
        ...
        idPasien = tblData.getValueAt(row, 0).toString();
        namaPasien = tblData.getValueAt(row, 1).toString();
        alamatPasien = tblData.getValueAt(row, 2).toString();
        teleponPasien = tblData.getValueAt(row, 3).toString();
