...
public class PanelCustom extends JPanel {
    ...
    protected void paintComponent(Graphics graphic) {
        ...
        if (roundTopLeft>0) {
            area.intersect(new Area(createRoundBottomoLeft()));
        }
        
        if (roundBottomRight>0) {
            area.intersect(new Area(createRoundBottomRigt()));
        }
    ...
    private Shape createRoundBottomoLeft() {
        int width = getWidth();
        int height = getHeight();
    ...
    private Shape createRoundBottomRigt() {
        int width = getWidth();
        int height = getHeight();
